...
void ImageCropperView::SetFocus()
{
    m_Controls.buttonCreateNewBoundingBox->setFocus();
}

void ImageCropperView::OnDataSelectionChanged(const mitk::DataNode* node)
{
...
void ImageCropperView::OnAdvancedSettingsButtonToggled()
{
    m_Controls.groupImageSettings->setVisible(m_Advanced);
    m_Advanced = !m_Advanced;
}

void ImageCropperView::CreateBoundingShapeInteractor(bool rotationEnabled)
{
    if (m_BoundingShapeInteractor.IsNull())
    {
        m_BoundingShapeInteractor = mitk::BoundingShapeInteractor::New();
        bool success = m_BoundingShapeInteractor->LoadStateMachine("BoundingShapeInteraction.xml", us::ModuleRegistry::GetModule("MitkBoundingShape"));
        success = m_BoundingShapeInteractor->SetEventConfig("BoundingShapeMouseConfig.xml", us::ModuleRegistry::GetModule("MitkBoundingShape"));
    }
    m_BoundingShapeInteractor->SetRotationEnabled(rotationEnabled);
}


mitk::Geometry3D::Pointer ImageCropperView::InitializeWithImageGeometry(mitk::BaseGeometry::Pointer geometry)
{
...
void ImageCropperView::DoCreateNewBoundingObject()
{
...
void ImageCropperView::OnSliderValueChanged(int slidervalue)
{
    m_CropOutsideValue = slidervalue;
}


void ImageCropperView::DoMasking()
{
    this->ProcessImage(true);
}

void ImageCropperView::DoCropping()
{
    this->ProcessImage(false);
}


void ImageCropperView::ProcessImage(bool mask)
{
...
void ImageCropperView::OnSelectionChanged(const QList<mitk::DataNode::Pointer>& nodes)
{
