...
void GraphCut<TImageType, TPixelDifferenceFunc>::CompareIndexCantainer(
...
template <typename TImageType, typename TPixelDifferenceFunc>
GraphCut<TImageType, TPixelDifferenceFunc>::GraphCut() :m_graph(NULL)
{
...
template <typename TImageType, typename TPixelDifferenceFunc>
void GraphCut<TImageType, TPixelDifferenceFunc>::Init()
{
    if (m_graph)
    {
        m_graph->reset();
...
template <typename TImageType, typename TPixelDifferenceFunc>
void GraphCut<TImageType, TPixelDifferenceFunc>::AddEdges()
{
