...
mitkStdMultiWidget::mitkStdMultiWidget(QWidget *parent,
    Qt::WindowFlags f,
...
void mitkStdMultiWidget::InitializeWidget()
{
...
void mitkStdMultiWidget::FillGradientBackgroundWithBlack()
{
...
std::pair<mitk::Color, mitk::Color> mitkStdMultiWidget::GetGradientColors(unsigned int widgetNumber)
{
    if (widgetNumber > 3)
    {
...
mitk::Color mitkStdMultiWidget::GetDecorationColor(unsigned int widgetNumber)
{
...
std::string mitkStdMultiWidget::GetCornerAnnotationText(unsigned int widgetNumber)
{
    if (widgetNumber > 3)
    {
        MITK_ERROR << "Decoration color for unknown widget!";
...
mitkStdMultiWidget::~mitkStdMultiWidget()
{
...
void mitkStdMultiWidget::RemovePlanesFromDataStorage()
{
...
void mitkStdMultiWidget::AddPlanesToDataStorage()
{
    if (m_PlaneNode1.IsNotNull() && m_PlaneNode2.IsNotNull() && m_PlaneNode3.IsNotNull() &&
        m_ParentNodeForGeometryPlanes.IsNotNull())
    {
...
void mitkStdMultiWidget::changeLayoutTo2DImagesUp()
{
...
void mitkStdMultiWidget::changeLayoutTo2DImagesLeft()
{
...
void mitkStdMultiWidget::SetDecorationProperties(std::string text, mitk::Color color, int widgetNumber)
{
    if (widgetNumber > 3)
    {
...
void mitkStdMultiWidget::SetCornerAnnotationVisibility(bool visibility)
{
    for (int i = 0; i < 4; ++i)
    {
...
bool mitkStdMultiWidget::IsCornerAnnotationVisible(void) const
{
    return m_CornerAnnotations[0]->GetVisibility() > 0;
}

QmitkRenderWindow *mitkStdMultiWidget::GetRenderWindow(unsigned int number)
{
    switch (number)
    {
    case 0:
...
void mitkStdMultiWidget::changeLayoutToDefault()
{
...
void mitkStdMultiWidget::changeLayoutToBig3D()
{
...
void mitkStdMultiWidget::changeLayoutToWidget1()
{
...
void mitkStdMultiWidget::changeLayoutToWidget2()
{
...
void mitkStdMultiWidget::changeLayoutToWidget3()
{
...
void mitkStdMultiWidget::changeLayoutToRowWidget3And4()
{
...
void mitkStdMultiWidget::changeLayoutToColumnWidget3And4()
{
...
void mitkStdMultiWidget::changeLayoutToRowWidgetSmall3andBig4()
{
    SMW_INFO << "changing layout to Widget3 and 4 in a Row..." << std::endl;
...
void mitkStdMultiWidget::changeLayoutToSmallUpperWidget2Big3and4()
{
    SMW_INFO << "changing layout to Widget3 and 4 in a Row..." << std::endl;
...
void mitkStdMultiWidget::changeLayoutTo2x2Dand3DWidget()
{
...
void mitkStdMultiWidget::changeLayoutToLeft2Dand3DRight2D()
{
...
void mitkStdMultiWidget::changeLayoutTo2DUpAnd3DDown(unsigned int id2Dwindow)
{
...
void mitkStdMultiWidget::SetDataStorage(mitk::DataStorage *ds)
{
    if (ds == m_DataStorage)
    {
        return;
...
void mitkStdMultiWidget::InitPositionTracking()
{
    // TODO POSITIONTRACKER
}

void mitkStdMultiWidget::AddDisplayPlaneSubTree()
{
...
mitk::SliceNavigationController *mitkStdMultiWidget::GetTimeNavigationController()
{
    return m_TimeNavigationController;
}

void mitkStdMultiWidget::EnableStandardLevelWindow()
{
...
void mitkStdMultiWidget::DisableStandardLevelWindow()
{
    levelWindowWidget->disconnect(this);
...
bool mitkStdMultiWidget::InitializeStandardViews(const mitk::Geometry3D *geometry)
{
    return m_RenderingManager->InitializeViews(geometry);
}

void mitkStdMultiWidget::RequestUpdate()
{
...
void mitkStdMultiWidget::ForceImmediateUpdate()
{
...
void mitkStdMultiWidget::wheelEvent(QWheelEvent *e)
{
    emit WheelMoved(e);
}

void mitkStdMultiWidget::mousePressEvent(QMouseEvent *)
{
}

void mitkStdMultiWidget::moveEvent(QMoveEvent *e)
{
    QWidget::moveEvent(e);
...
QmitkRenderWindow *mitkStdMultiWidget::GetRenderWindow1() const
{
    return mitkWidget1;
}

QmitkRenderWindow *mitkStdMultiWidget::GetRenderWindow2() const
{
    return mitkWidget2;
}

QmitkRenderWindow *mitkStdMultiWidget::GetRenderWindow3() const
{
    return mitkWidget3;
}

QmitkRenderWindow *mitkStdMultiWidget::GetRenderWindow4() const
{
    return mitkWidget4;
}

const mitk::Point3D mitkStdMultiWidget::GetCrossPosition() const
{
...
void mitkStdMultiWidget::EnablePositionTracking()
{
}

void mitkStdMultiWidget::DisablePositionTracking()
{
}

void mitkStdMultiWidget::EnsureDisplayContainsPoint(mitk::BaseRenderer *renderer, const mitk::Point3D &p)
{
...
void mitkStdMultiWidget::MoveCrossToPosition(const mitk::Point3D &newPosition)
{
...
void mitkStdMultiWidget::HandleCrosshairPositionEvent()
{
...
mitk::DataNode::Pointer mitkStdMultiWidget::GetTopLayerNode(mitk::DataStorage::SetOfObjects::ConstPointer nodes)
{
...
void mitkStdMultiWidget::HandleCrosshairPositionEventDelayed()
{
    m_PendingCrosshairPositionEvent = false;
...
int mitkStdMultiWidget::GetLayout() const
{
    return m_Layout;
}

bool mitkStdMultiWidget::GetGradientBackgroundFlag() const
{
    return m_GradientBackgroundFlag;
}

void mitkStdMultiWidget::EnableGradientBackground()
{
...
void mitkStdMultiWidget::DisableGradientBackground()
{
    for (unsigned int i = 0; i < 4; ++i)
    {
...
void mitkStdMultiWidget::EnableDepartmentLogo()
{
    m_LogoRendering->SetVisibility(true);
    RequestUpdate();
}

void mitkStdMultiWidget::DisableDepartmentLogo()
{
    m_LogoRendering->SetVisibility(false);
    RequestUpdate();
}

bool mitkStdMultiWidget::IsDepartmentLogoEnabled() const
{
    return m_LogoRendering->IsVisible();
}

void mitkStdMultiWidget::SetWidgetPlaneVisibility(const char *widgetName, bool visible, mitk::BaseRenderer *renderer)
{
    if (m_DataStorage.IsNotNull())
    {
...
void mitkStdMultiWidget::SetWidgetPlanesVisibility(bool visible, mitk::BaseRenderer *renderer)
{
    if (m_PlaneNode1.IsNotNull())
    {
...
void mitkStdMultiWidget::SetWidgetPlanesLocked(bool locked)
{
...
void mitkStdMultiWidget::SetWidgetPlanesRotationLocked(bool locked)
{
    // do your job and lock or unlock slices.
...
void mitkStdMultiWidget::SetWidgetPlanesRotationLinked(bool link)
{
    emit WidgetPlanesRotationLinked(link);
}

void mitkStdMultiWidget::SetWidgetPlaneMode(int userMode)
{
...
void mitkStdMultiWidget::SetGradientBackgroundColorForRenderWindow(const mitk::Color &upper,
...
void mitkStdMultiWidget::SetGradientBackgroundColors(const mitk::Color &upper, const mitk::Color &lower)
{
    for (unsigned int i = 0; i < 4; ++i)
    {
...
void mitkStdMultiWidget::SetDepartmentLogo(const char *path)
{
...
void mitkStdMultiWidget::SetWidgetPlaneModeToSlicing(bool activate)
{
    if (activate)
    {
...
void mitkStdMultiWidget::SetWidgetPlaneModeToRotation(bool activate)
{
    if (activate)
    {
...
void mitkStdMultiWidget::SetWidgetPlaneModeToSwivel(bool activate)
{
    if (activate)
    {
...
void mitkStdMultiWidget::OnLayoutDesignChanged(int layoutDesignIndex)
{
...
void mitkStdMultiWidget::UpdateAllWidgets()
{
...
void mitkStdMultiWidget::HideAllWidgetToolbars()
{
...
void mitkStdMultiWidget::ActivateMenuWidget(bool state)
{
...
bool mitkStdMultiWidget::IsMenuWidgetEnabled() const
{
    return mitkWidget1->GetActivateMenuWidgetFlag();
}

void mitkStdMultiWidget::SetDecorationColor(unsigned int widgetNumber, mitk::Color color)
{
    switch (widgetNumber)
    {
    case 0:
...
void mitkStdMultiWidget::ResetCrosshair()
{
    if (m_DataStorage.IsNotNull())
    {
...
void mitkStdMultiWidget::EnableColoredRectangles()
{
...
void mitkStdMultiWidget::DisableColoredRectangles()
{
...
bool mitkStdMultiWidget::IsColoredRectanglesEnabled() const
{
    return m_RectangleProps[0]->GetVisibility() > 0;
}

mitk::MouseModeSwitcher *mitkStdMultiWidget::GetMouseModeSwitcher()
{
    return m_MouseModeSwitcher;
}

mitk::DataNode::Pointer mitkStdMultiWidget::GetWidgetPlane1()
{
    return this->m_PlaneNode1;
}

mitk::DataNode::Pointer mitkStdMultiWidget::GetWidgetPlane2()
{
    return this->m_PlaneNode2;
}

mitk::DataNode::Pointer mitkStdMultiWidget::GetWidgetPlane3()
{
    return this->m_PlaneNode3;
}

mitk::DataNode::Pointer mitkStdMultiWidget::GetWidgetPlane(int id)
{
    switch (id)
    {
    case 1:
