...
const char SHOW_DESCRIPTIONS[] = "show descriptions";
const char SHOW_ALIASES_IN_DESCRIPTION[] = "show aliases in description";
const char SHOW_PERSISTENCE_IN_DESCRIPTION[] = "show persistence in description";
const char DEVELOPER_MODE[] = "enable developer mode";
...
void QmitkPropertyTreeView::CreateView()
{
    m_pMain->Attach(this);
...
void QmitkPropertyTreeView::OnSelectionChanged(const QList<mitk::DataNode::Pointer>& nodes)
{
  mitk::PropertyList* propertyList = m_Model->GetPropertyList();
