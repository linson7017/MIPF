...
#ifndef NodeDescriptorManager_h
#define NodeDescriptorManager_h
...
/**
 * \ingroup QmitkModule
 * \brief NodeDescriptorManager manages a set of QmitkNodeDescriptors
 *
 * \sa QmitkNodeDescriptor
 */
class  NodeDescriptorManager:public QObject 
{
public:
  ///
  /// \return the solely instance of NodeDescriptorManager
  ///
  ///
  ...
  ///
  /// Initializes the NodeDescriptorManager.
