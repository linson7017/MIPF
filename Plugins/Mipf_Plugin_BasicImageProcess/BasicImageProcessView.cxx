...
void BasicImageProcessView::CreateConnections()
{
    if (m_Controls)
    {
...
void BasicImageProcessView::SetFocus()
{
    m_Controls->rBOneImOp->setFocus();
}

//datamanager selection changed
void BasicImageProcessView::OnSelectionChanged(const QList<mitk::DataNode::Pointer>& nodes)
{
    //any nodes there?
    if (!nodes.empty())
    {
...
void BasicImageProcessView::ChangeGUI()
{
...
void BasicImageProcessView::ResetOneImageOpPanel()
{
...
void BasicImageProcessView::ResetParameterPanel()
{
...
void BasicImageProcessView::ResetTwoImageOpPanel()
{
...
void BasicImageProcessView::SelectAction(int action)
{
...
void BasicImageProcessView::StartButtonClicked()
{
    if (!m_SelectedImageNode->GetNode()) return;
...
void BasicImageProcessView::SelectAction2(int operation)
{
    // check which operation the user has selected and set parameters and GUI accordingly
    switch (operation)
    {
...
void BasicImageProcessView::StartButton2Clicked()
{
...
void BasicImageProcessView::SelectInterpolator(int interpolator)
{
    switch (interpolator)
    {
    case 0:
