...
template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::Release()
{
    delete this;
}
template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::SetImage(Float3DImageType* pInputImage)
{
    setImage(pInputImage);
}
template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::SetNumIter(int iIteratorNumber)
{
    setNumIter(iIteratorNumber);
}
template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::SetMaxVolume(int iMaxVolume)
{
    setMaxVolume(iMaxVolume);
}
template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::SetInputLabeledImage(UShort3DImageType* pLabelImage)
{
    setInputLabelImage(pLabelImage);
}

template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::SetMaxRunningTime(int iMaxTime)
{
    setMaxRunningTime(iMaxTime);
}

template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::SetIntensityHomogeneity(double dHomogeneity)
{
    setIntensityHomogeneity(dHomogeneity);
}

template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::SetCurvatureWeight(double dCurvatureWeight)
{
    setCurvatureWeight(dCurvatureWeight);
}

template <typename TPixel>
void CSFLSRobustStatSegmentor3DLabelMap<TPixel>::PerformSegmentation()
{
    doSegmenation();
}

template <typename TPixel>
Float3DImageType* CSFLSRobustStatSegmentor3DLabelMap<TPixel>::GetResult()
{
    return CSFLSSegmentor3D::getLevelSetFunction();
}
